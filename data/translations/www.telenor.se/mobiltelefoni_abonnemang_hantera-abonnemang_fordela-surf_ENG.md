...
Do some family members surf more than others? Then you can share data by setting
data limits, so that everyone gets as much as they need.

You who have the [member profile Owner](/support/mobiltelefoni/abonnemang/for-
familjen/medlemsprofiler/) in Telenor Family (i.e. you who are responsible for
payment for the subscription) can share the data between the other
members by **setting data limits –** even if you share unlimited
data.  
  
You set data limits in My Telenor – either here [on the web](/mitt-
telenor/) or in [our app](/archive/2019/mitt-telenor-old/).

  
[Read more about member profiles in Telenor
Family](/support/mobiltelefoni/abonnemang/for-familjen/medlemsprofiler/)
