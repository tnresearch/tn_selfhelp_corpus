...
__ Welcome!
  ...
  * [Log out](/UserLogout)
  ...
  5. Volume buttons are not working

# Volume buttons are not working

The volume buttons on the remote control for our Mediahub are currently not working
with some TVs. We are fixing it, and in the meantime
you can use the volume buttons on your TV's remote control instead.
