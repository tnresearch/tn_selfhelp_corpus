...
Here's how to install the latest version of the operating system
(also known as a software update) on your mobile. This will ensure that your
mobile functions as well as possible, and most importantly, as securely as
possible.
  ...
  * ### Search for "Software update" and click

  * ### Select "Download and install" or "Download automatically via Wi-Fi"

  * ### Your mobile searches for available updates

  * ### If an update is available, this screen will appear and the download will begin

If the screen does not appear, you already have the latest version.
...
[Previous](/link/43b3c9a6729e4e15a608a65e234034a6.aspx)
