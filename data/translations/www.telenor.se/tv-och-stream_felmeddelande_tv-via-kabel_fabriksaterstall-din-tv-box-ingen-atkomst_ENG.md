...
Grab the remote control and then do the following:
  ...
  3. Select Reset User Settings. Now you will see this text: "All channels and schedules will be deleted. All user settings will be reset to factory settings. Continue?". Select YES.
  4. Enter your password if you want to continue. The default password is 0000.
  5. The box will restart. Follow the instructions on the TV screen.
