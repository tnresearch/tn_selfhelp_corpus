...
# Surf with a Network Cable

If you don't have a router yet but still want to surf, you can use a
network cable. Connect it between your computer and the fiber outlet. Should only take a
minute or so to fix.
