...
Use prioritize devices when you want the connection not to be affected by
someone else's use of the network.

  * ### Select devices in the menu

Then click on the device you want to prioritize.

  * ### Activate bandwidth prioritization

  * ### Choose how long you want the device to be prioritized

Select how long you want the device to be prioritized.

Click the checkmark in the upper right corner to confirm your choice.
