...
__ Welcome!
  ...
  * [Log out](/UserLogout)
  ...
  5. Check the audio settings in your TV box

# Check the audio settings in your TV box

You may need to change the audio settings in your TV box. Get the remote
control and then do the following.

  1. Select **Menu** and then **Settings**
  2. Select **System settings** and then **Audio format (HDMI/SPDIF)**
  3. Change the audio format to **Stereo/Stereo** or **Stereo/Dolby Digital**
