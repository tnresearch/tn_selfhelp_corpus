...
### For iPhone.
  ...
  1. Go to **Settings**.
  2. Select **Cellular**.
  3. Select **Cellular Data Network**. APN should be services.telenor.se.
...
For Android
  ...
  3. Select **Access Point Names**. APN should be services.telenor.se.

  
**Is anything other than services.telenor.se displayed?** Then you can [reset the network](/support/mobiltelefoni/guider/problemlosning-och-felsokning/valj-
mobil/aterstall-natverk/).
...
och-felsokning/felsokning/kolla-mottagningsforhallanden/)
