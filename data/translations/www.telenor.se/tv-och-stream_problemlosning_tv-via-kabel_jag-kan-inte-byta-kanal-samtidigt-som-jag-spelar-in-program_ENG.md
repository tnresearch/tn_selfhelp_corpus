...
# I can't change channels while recording a program

This may be because you have four program recordings running. In that case, you cannot
change channels at the same time.  

Cancel one of the recordings or wait until one of them is finished. Then you can change
the channel.
...
kabel/det-kan-vara-fel-pa-din-fjarrkontroll/)
