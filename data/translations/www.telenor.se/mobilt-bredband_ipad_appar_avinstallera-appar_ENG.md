...
__ Welcome!
  ...
  * [Log out](/UserLogout)
  ...
  4. [iPad](/support/mobilt-bredband/ipad/)
  5. Uninstall apps

# Uninstall apps on iPad

Here we show you how to remove apps from an iPad. Follow the simple guide step
by step.

  * ### Browse to the app you want to uninstall

  * ### Hold your finger on the app you want to remove.

Hold down until you see an X on the edge of the app.

  * ### Tap the X

  * ### Tap "Delete" to confirm.

Now the app is uninstalled. You did well.
