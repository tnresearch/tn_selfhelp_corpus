...
__ Welcome!
  ...
  * [Log out](/UserLogout)
  ...
  1. [Start](/)
  2. [Support](/support/)
  3. Why is the invoice amount different than I expected?

1

# Why is the invoice amount different than I expected?

The invoice amount can change from month to month, and it can be due to many
different things, but the most common reason is that you have **purchased**
something or **changed** something in your subscription. Or simply purchased a
new subscription, as the **first invoice is often higher** than the following
ones.  
  
[Read all about unexpected or high invoice amounts here](/support/faktura/ovantat-
eller-hogt-fakturabelopp/)
...
cannot be turned off. Necessary cookies enable basic functionality, so that you
