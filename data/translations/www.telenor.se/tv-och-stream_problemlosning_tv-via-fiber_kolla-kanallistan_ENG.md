...
Check if you have created a channel list and which channels are included in it. Take
out the remote control and then do the following:

  1. Press **Menu**
  2. Press **Settings**
  3. Press **Channel List**
