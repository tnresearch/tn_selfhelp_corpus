Directly to content
  ...
  5. [ DNA Prepaid Travel Modem 4G WLAN MF90+ ](https://www.dna.fi/tuki/laitteet/mokkulat/matkamokkulat/dna-prepaid-matkamokkula-4g-wlan-mf90)
  6. Features
...
**Product Name: ZTE MF90+**  

Prepaid Travel Modem that supports 4G connectivity. The modem is available to Prepaid customers.  
You can share the mobile connection wirelessly via Wi-Fi, but the MF90+ also works as a USB modem.

  * 4G LTE (CAT3) maximum speed from the network 100 Mbit/s
  * 3G Dual Carrier maximum speed 42 Mbit/s Dual Carrier maximum speed 42 Mbit/s 
  * HSPA+ maximum speed 21.1 Mbit/s
  * MicroSD memory card slot Micro SDHC, 2G-32 GByte Capacity, SD 2.0 Class 6
  * TS9 interface for external antenna
  * The modem is connected directly to the computer's USB port.
  * Mini-SIM or standard-sized SIM card

### Sales package contents:

DNA Prepaid Travel Modem 4G WLAN MF90+, USB extension cable, quick start guide.

### Hardware requirements / Supported operating systems:

  * Supported operating systems Windows XP SP2/SP3, Vista SP1/SP2, Windows 7, Windows 8 / 8.1, Windows 10, MAC OSX: 10.8,-9,-10,-11
