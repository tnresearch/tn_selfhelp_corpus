...
__ Welcome!
  ...
  * [Log out](/UserLogout)
  ...
  5. Picture is frozen or stuttering

# Picture is frozen or stuttering

This applies to those of you who have **Telenor Mediahubb**.  
  
If you are using the media hub together with the router **Technicolor TG799**, you
may experience stuttering/freezing of the picture if you have not connected the
media hub with a **network cable**. So try doing that.
