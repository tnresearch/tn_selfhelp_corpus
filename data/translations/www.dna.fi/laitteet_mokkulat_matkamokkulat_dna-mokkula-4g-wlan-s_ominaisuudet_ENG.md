Directly to content
  ...
  5. [ DNA Modem 4G WLAN S ](https://www.dna.fi/tuki/laitteet/mokkulat/matkamokkulat/dna-mokkula-4g-wlan-s)
  6. Features
...
**Product Name: Sierra Wireless Aircard 762S**

The DNA Modem 4G WLAN S shares a 4G or 3G connection with up to 10 devices.  
An easy-to-use Home Base is available for the modem, which increases the range and speed of the WLAN network.

  * 4G LTE maximum speed from the network 100 Mbit/s
  * 4G DC maximum speed 42 Mbit/s
  * HSPA+ maximum speed 21.1 Mbit/s
  * WLAN b/g/n
  * 10 WLAN devices (maximum speed of 35 Mbit/s per device)
  * 2000 mAh battery and large 5-line LCD screen
  * TS9 connector for external antenna
  * 100 MB of storage space
  * MicroSD memory card slot (up to 32 GB), also works over WLAN
  * Mini-SIM card, i.e. a standard-sized SIM card

### Hardware Requirements / Supported Operating Systems

  * USB connection: Windows® 8.1, Windows® 8, Windows® 7, Vista, XP Mac OS X® 10.5
  * WLAN: 802.11b/g/n
  * USB Slot 1.1 or 2.0
  * 100 MB of storage space
