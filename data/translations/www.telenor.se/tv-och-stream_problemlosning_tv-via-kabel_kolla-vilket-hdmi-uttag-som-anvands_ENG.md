...
# Check which HDMI port is being used

  
Look at the back of the TV to see which port you have plugged the HDMI cable into. Then
bring out the TV remote and **select the same port** under the Source menu
option or similar.
