...
# Activate and deactivate mobile data

Mobile data is on by default, meaning you make calls and browse via the
mobile network using your data allowance. In [My Telenor](/mitt-telenor/) you
can see how much data is included in your subscription.

If you do not want to use your data allowance and have access to a wifi
network, you can deactivate mobile data.
