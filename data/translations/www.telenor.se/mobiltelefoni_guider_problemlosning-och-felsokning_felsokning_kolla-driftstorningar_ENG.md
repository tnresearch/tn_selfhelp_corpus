...
Check if there are any service disruptions where you are, if you haven't
already done so. Just take a look at the map here next to it.

**  
Tip!** You can also check for service disruptions in My Telenor, either in the app
or [on the web](/mitt-telenor/).

[Learn more about the app](/handla/tjanster/appar/mitt-telenor/)
...
och-felsokning/felsokning/hur-upplever-du-ditt-problem/)
