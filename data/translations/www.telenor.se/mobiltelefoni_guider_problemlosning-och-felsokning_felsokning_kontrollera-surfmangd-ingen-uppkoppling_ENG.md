...
If you have a subscription with limited data and have used it up,
you cannot browse*. In My Telenor you can see if your data allowance has been exceeded.
And easily buy more data if you want!

In My Telenor, which is available both here [on the web](/mitt-telenor/) and as an [
app](/handla/tjanster/appar/mitt-telenor/), you can see not only how much data
you have used. You can also purchase new data.

* You can still access the following sites: [Telenor.se](/), [My Telenor](/mitt-telenor/), [reload.telenor.se](/handla/kontantkort/ladda-kontantkort/#products), [Vimla.se](https://vimla.se/). You can also receive and send MMS and use the Telenor app (if you have downloaded it previously).
...
och-felsokning/felsokning/kolla-flygplanslage/)
