...
Automatic software version updates are enabled by default on the DNA Home Modem 4G WiFi MF289F. The device can also be updated manually by logging into the device's settings page, selecting **Advanced Settings** from the bottom of the page, choosing **Update**, and then pressing **Check**. If a new version is found, follow the instructions in the pop-up window.

#### **MF289F has received an update starting 5.6.2023:**

The software version includes several minor fixes and improvements to the device's operation.

New software version: CR_DNAFIMF289FV1.0.0B12

Did you find the information you were looking for on this page? Your feedback is important!  44 responses
