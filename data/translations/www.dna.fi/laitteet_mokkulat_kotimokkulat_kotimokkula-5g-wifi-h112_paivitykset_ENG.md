Directly to content
  ...
  5. [ Home Modem 5G WiFi H112 ](https://www.dna.fi/tuki/laitteet/mokkulat/kotimokkulat/kotimokkula-5g-wifi-h112)
  6. Updates
...
The Home Modem H112 is updated by logging into the settings pages and selecting the "Updates" tab from behind the "Advanced Settings" menu, and following the instructions on the site. Please note that you can also set the modem to update itself automatically during the first login to the management pages and later from the management pages via the path "Advanced Settings" > "System" > "System Settings".

**H112 has received an update starting November 2, 2020:**

  * The update includes bug fixes and improved reliability made by the device manufacturer.

New software version: 10.0.5.11 (H351SP3C6201)  
New web interface software version: 10.0.5.1 (W2SP3C6201)
