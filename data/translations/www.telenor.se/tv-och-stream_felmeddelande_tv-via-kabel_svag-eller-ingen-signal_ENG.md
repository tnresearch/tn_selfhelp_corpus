...
Are you seeing the error message "Weak or No Signal" on your TV screen?

  
Start by checking the connections:

  * check that your TV box is correctly connected
  * also check that the antenna cable is connected directly to your antenna socket and not via any extra equipment, such as a T-connector or any type of adapter

The picture here shows where to connect the various cables.  
1. Antenna cable  
2. HDMI cable  
3. Power cable
