...
__ Welcome!
  ...
  * [Log out](/UserLogout)
  ...
  6. Rename and categorize devices

# Rename and categorize devices

  * ### Click on devices in the menu

Then click on the device you want to change settings for.

  * ### Click on the three dots in the upper right corner

Click on the three dots in the upper right corner and then on edit.

  * ### Choose name and category

Enter a new name and choose a suitable category.

Click the checkmark in the upper right corner to save.
