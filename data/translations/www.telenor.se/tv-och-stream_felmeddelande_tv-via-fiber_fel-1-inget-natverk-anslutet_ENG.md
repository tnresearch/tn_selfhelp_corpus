...
# Error 1: No network connected

Are you getting the error message **Error 1: No network connected** on your TV screen?  
  
Start by checking the connection. Make sure you have a network cable running
between your TV box and the service distributor, broadband outlet, or router.  
  
If the cable is connected to a service distributor, [check that it is in the
