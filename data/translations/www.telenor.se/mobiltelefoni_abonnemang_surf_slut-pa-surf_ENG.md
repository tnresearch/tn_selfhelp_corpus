...
__ Welcome!
  ...
  * [Log out](/UserLogout)
  ...
  5. Data limit reached

# Oops, your data has run out!

Do you want to purchase extra data? Whether you are at home or abroad, you can top
up your data at a fixed price.

[ ](/mitt-telenor/)

All about buying extra data

  * 1 GB costs 99 SEK
  * 3 GB costs 149 SEK
  * 10 GB costs 249 SEK
  * **You buy more data in My Telenor** – either here [on the web](/mitt-telenor/) or in [our app. ](/archive/2019/mitt-telenor-old/) You can always access the app, even if your data has run out.
  * You can also order more data via SMS. Send "LADDA1/3/10GB" to 222. That is, if you want 3GB, write "LADDA3GB".
  * The data is loaded immediately and can be used until the end of the month.
  * Are there several users? Your new data is available to all users, but you cannot distribute the data.

Do you often need to buy extra data? Then maybe you should change your data allowance.
It's easier than you think! [Read more about changing your
data allowance](/support/mobiltelefoni/abonnemang/surf/byta-surfmangd/)
