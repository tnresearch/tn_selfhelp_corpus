...
The channels you are missing may be in a different channel list.
...
Here's how:
  ...
  3. Press Channel Settings and then Edit Favorites List
  4. Enter the PIN code 0000
  5. Press the yellow button and then select channel list
