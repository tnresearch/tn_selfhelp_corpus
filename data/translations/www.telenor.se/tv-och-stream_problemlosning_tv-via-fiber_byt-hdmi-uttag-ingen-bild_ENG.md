...
__ Welcome!
  ...
  * [Log out](/UserLogout)
  ...
  5. Try a different HDMI port - no picture

# Try a different HDMI port

Plug the HDMI cable into a different port on the TV. Remember to select the same port
under Source using the TV remote control.
...
Needed to make the website function securely and correctly. Therefore, they cannot
