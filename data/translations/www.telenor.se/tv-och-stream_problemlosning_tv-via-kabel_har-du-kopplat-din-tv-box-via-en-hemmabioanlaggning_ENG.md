...
speaker system (a so-called soundbar), the problem may be there.  
  
Try connecting the TV box directly to the TV and see if the sound works then. If
the problem is due to your home theater system, you may need to review
the sound settings in it.
...
kabel/kolla-ljudinstallningarna-i-din-tv-box/)
