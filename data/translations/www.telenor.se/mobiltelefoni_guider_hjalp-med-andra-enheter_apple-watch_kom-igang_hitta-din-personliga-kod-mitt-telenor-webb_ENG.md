...
__ Welcome!
  ...
  * [Log out](/UserLogout)
  ...
  5. [Apple Watch](/support/mobiltelefoni/guider/hjalp-med-andra-enheter/apple-watch/)
  6. Find your personal code (My Telenor on the web)

# Find your personal code (My Telenor on the web)

Here's how to find your personal code in [My Telenor](/mitt-telenor/
"My Telenor") here on the web.  
  
**Tip!** If you don't see the code, you must first verify yourself as  
a user of the mobile number you want to link to the watch. You verify
yourself as a user on the My Overview page in My Telenor.  
  ...
  * ### Scroll down to the Personal code section
