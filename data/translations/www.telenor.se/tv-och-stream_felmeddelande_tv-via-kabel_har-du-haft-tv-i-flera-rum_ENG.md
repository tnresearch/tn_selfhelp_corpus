...
# Have you had TV in multiple rooms?

If so, you have had more than one TV box. If you recently stopped using one of
them and have not yet returned it to us, you can check if that box is
working.
...
[ No, I need more help ](/support/tv-and-stream/error-message/tv-via-
cable/have-you-received-a-new-tv-box-from-us/)
...
cannot be turned off. Necessary cookies enable basic functionality, so that
