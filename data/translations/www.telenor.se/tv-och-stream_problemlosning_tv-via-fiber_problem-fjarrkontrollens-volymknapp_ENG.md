...
# Problem with the volume button on the remote control

This applies to those of you who have **Telenor Mediahubb**.  
  
Does nothing happen when you try to change the volume with the remote control that comes with
Mediahub?  
  
If so, use the volume button on your TV to adjust the volume.
