...
Start by checking if there is any service disruption in your area.

Do this:

  1. Enter the address or town where you are experiencing the problem.
  2. If the area is shown as orange or red, look at the list under the map for information on when the disruption is expected to be resolved.
