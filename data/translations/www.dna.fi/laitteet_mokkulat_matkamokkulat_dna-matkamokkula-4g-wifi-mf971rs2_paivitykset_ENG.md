...
#### MF791RS2 has received an update since August 16, 2023

####

  * The update includes security fixes related to the device from the device manufacturer.

  * New software version: BD_DNAMF971RS2V1.0.1B03
...
**December 14, 2022**
  ...
  * The update includes security fixes related to the device from the device manufacturer.
  * New software version: DNA_FI_MF971RS2V1.0.1B01

**February 28, 2022**

  * The update includes fixes that improve the general functionality of the device from the device manufacturer.
  * New software version: BD_DNAMF971RS2V1.0.0B02
