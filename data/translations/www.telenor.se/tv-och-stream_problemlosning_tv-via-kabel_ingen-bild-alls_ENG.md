...
First, check if the TV box is turned on.

  
On the front of the box is a standby button. Press the button to see if
the box is on. If the button lights up green, it means the TV box is
on. If it lights up red, the box is in standby mode or a recording is in
progress.
...
cable/check-if-there-is-a-service-disruption/)
