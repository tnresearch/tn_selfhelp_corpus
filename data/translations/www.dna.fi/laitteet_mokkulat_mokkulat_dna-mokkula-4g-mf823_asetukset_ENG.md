...
Every time you connect the modem to your computer, your web browser automatically opens the modem management page. If you exit the page and want to return to it, type **http://192.168.0.1** into the browser's address bar.

On the modem management page, you can change or disable your PIN code, as well as modify other modem settings.
