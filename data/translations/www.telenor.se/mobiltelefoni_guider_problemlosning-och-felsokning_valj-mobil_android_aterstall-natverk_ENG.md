...
Network settings are also called APN settings. Resetting the network can
solve problems with connecting to the mobile network.
...
Now you have the latest version installed, right? Then let's go!
  ...
  * ### Search for "Reset Network Settings" (connection and sharing if you have Xiaomi)

  * ### Select "Reset WiFi, Mobile network and Bluetooth". 
