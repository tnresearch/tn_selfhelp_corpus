...
__ Welcome!
  ...
  * [Log out](/UserLogout)
  ...
  1. [Start](/)
  2. [Support](/support/)
  3. What is a patch panel?

1

# What is a patch panel?

In some houses and apartments, there is a patch panel. With its help, a
local wired network (home network) is created that allows you to choose
exactly where you want to connect your router and TV box – without having
cables all over the house. Very practical!

The patch panel is often located in a connection cabinet in the hallway,
together with a list of which outlets are in which rooms.
