...
Grab the remote control and then do the following:

  1. Select Home on the remote control and then Settings
  2. Select System Settings and then Factory Reset
  3. Select Reset User Settings
  4. Now you will see this text: "All channels and schedules will be deleted. All user settings will be reset to factory settings. Continue?". Select YES.
  5. Enter your password if you want to continue. The default password is 0000.
  6. The box will restart. Follow the instructions on the TV screen.
