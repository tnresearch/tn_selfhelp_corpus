...
__ Welcome!
  ...
  * [Log out](/UserLogout)
  ...
  5. Incorrect local news is displayed

# Incorrect local news is displayed

Are you only seeing local news from Stockholm, even though you live somewhere else? This is probably because the media hub is connected incorrectly. Here's how to fix it.

  * ### Find out what applies to your address

You can do this by searching for your address on the page
[telenor.se/port](/support/portar/)

  * ### Click on the search result for Telenor Mediahub

It will tell you whether you should connect according to scenario 2A or 2B.

  * ### Follow the connection instructions

[You can find the connection guide here](/support/tv-och-stream/kom-
igang/box/telenor-mediahubb/)
