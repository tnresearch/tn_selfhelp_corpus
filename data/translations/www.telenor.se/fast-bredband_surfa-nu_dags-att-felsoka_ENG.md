...
__ Welcome!
  ...
  * [Log out](/UserLogout)
  ...
  5. Time to troubleshoot?

# Time to troubleshoot your broadband?

Perform an automatic or manual troubleshooting, depending on the type of
connection you have.

Automatic

Works if you have fiber and if Telenor was the **only possible provider**
when you acquired broadband. You do this in My Telenor.  

[Log in](/mitt-telenor/)

City Networks and DSL

Manual

Works if you chose between **several fiber providers** in a city network*. Or
if you have broadband via the telephone jack (DSL). You do this without logging in.  

[Start the manual troubleshooting](/support/fast-bredband/felsokning/hur-
upplever-du-problemet-med-ditt-bredband/)

_*Example: Open Universe, Zitius, IP-Only_
