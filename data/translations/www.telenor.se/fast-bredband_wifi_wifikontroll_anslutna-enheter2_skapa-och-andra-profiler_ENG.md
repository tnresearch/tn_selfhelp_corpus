...
__ Welcome!
  ...
  * [Log out](/UserLogout)
  ...
  6. Create and edit profiles

# Create and edit profiles

  * ### Create profiles

Click on profiles in the menu and then create new

Enter the profile name and then continue

Select which devices the profile should have access to. Then click the blue
checkmark in the upper right corner to confirm your selections.

  * ### Edit or delete profiles

To edit or delete profiles, click on the three dots in the
upper right corner.

If you want to delete a profile, confirm by clicking on "delete"-
